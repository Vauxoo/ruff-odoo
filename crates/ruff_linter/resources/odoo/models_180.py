# Odoo 18.0 ORM model method signatures, read from odoo/models.py
# at odoo/18.0 (ec79381d98fd49fe8aeb4f417e3458f8d3210bb9).
#
...
class BaseModel:
    ...
    def _field_to_sql(self, alias, fname, query=..., flush=...): ...
    ...
    def _load_records(self, data_list, update=..., ignore_duplicates=...): ...
    ...
    def _read_group_groupby_properties(self, fname, property_name, query): ...
    ...
    def _search(self, domain, offset=..., limit=..., order=...): ...
