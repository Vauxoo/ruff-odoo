...
pub fn code_to_rule(linter: Linter, code: &str) -> Option<(RuleGroup, Rule)> {
    ...
    Some(match (linter, code) {
        ...
        // odoo: the code after the "OD" prefix is the pylint-odoo message id the rule was
        // ported from, category letter included, so a project migrating off pylint-odoo can
        // read `ODE8103` as the `E8103` it already knows. The 85xx block is this fork's own:
        // it numbers the rules with no pylint-odoo counterpart (ports of OCA
        // odoo-pre-commit-hooks checks, and rules invented here), kept clear of pylint-odoo's
        // ranges so a future pylint-odoo message cannot collide with one of ours.
        (Odoo, "C8101") => rules::odoo::rules::ManifestRequiredAuthor,
        (Odoo, "C8102") => rules::odoo::rules::ManifestRequiredKey,
        (Odoo, "C8103") => rules::odoo::rules::ManifestDeprecatedKey,
        (Odoo, "C8105") => rules::odoo::rules::LicenseAllowed,
        (Odoo, "C8106") => rules::odoo::rules::ManifestVersionFormat,
        (Odoo, "C8107") => rules::odoo::rules::TranslationRequired,
        (Odoo, "C8108") => rules::odoo::rules::MethodCompute,
        (Odoo, "C8109") => rules::odoo::rules::MethodSearch,
        (Odoo, "C8110") => rules::odoo::rules::MethodInverse,
        (Odoo, "C8111") => rules::odoo::rules::DevelopmentStatusAllowed,
        (Odoo, "C8112") => rules::odoo::rules::MissingReadme,
        (Odoo, "C8113") => rules::odoo::rules::NoWizardInModels,
        (Odoo, "C8114") => rules::odoo::rules::CategoryAllowed,
        (Odoo, "C8115") => rules::odoo::rules::MissingOdooFile,
        (Odoo, "C8116") => rules::odoo::rules::ManifestSuperfluousKey,
        ...
        (Odoo, "E8104") => rules::odoo::rules::ManifestMaintainersList,
        (Odoo, "E8106") => rules::odoo::rules::ExternalRequestTimeout,
        (Odoo, "E8130") => rules::odoo::rules::TestFolderImported,
        (Odoo, "E8135") => rules::odoo::rules::NoWriteInCompute,
        (Odoo, "E8140") => rules::odoo::rules::NoRaiseUnlink,
        (Odoo, "E8145") => rules::odoo::rules::ManifestBehindMigrations,
        (Odoo, "E8146") => rules::odoo::rules::DeprecatedNameGet,
        (Odoo, "E8147") => rules::odoo::rules::InheritableMethodString,
        (Odoo, "E8148") => rules::odoo::rules::InheritableMethodLambda,
        (Odoo, "E8149") => rules::odoo::rules::DeprecatedInselectOperator,
        (Odoo, "E8151") => rules::odoo::rules::TranslationInjection,
        (Odoo, "E8300") => rules::odoo::rules::TranslationUnsupportedFormat,
        (Odoo, "E8301") => rules::odoo::rules::TranslationFormatTruncated,
        ...
        (Odoo, "R8181") => rules::odoo::rules::InvalidEmail,
        (Odoo, "W8103") => rules::odoo::rules::TranslationField,
        (Odoo, "W8105") => rules::odoo::rules::AttributeDeprecated,
        (Odoo, "W8106") => rules::odoo::rules::MethodRequiredSuper,
        (Odoo, "W8107") => rules::odoo::rules::ProhibitedMethodOverride,
        (Odoo, "W8110") => rules::odoo::rules::MissingReturn,
        (Odoo, "W8111") => rules::odoo::rules::RenamedFieldParameter,
        (Odoo, "W8113") => rules::odoo::rules::AttributeStringRedundant,
        (Odoo, "W8114") => rules::odoo::rules::WebsiteManifestKeyNotValidUri,
        (Odoo, "W8115") => rules::odoo::rules::TranslationContainsVariable,
        (Odoo, "W8120") => rules::odoo::rules::TranslationPositionalUsed,
        (Odoo, "W8121") => rules::odoo::rules::ContextOverridden,
        (Odoo, "W8125") => rules::odoo::rules::ManifestDataDuplicated,
        (Odoo, "W8138") => rules::odoo::rules::ExceptPass,
        (Odoo, "W8150") => rules::odoo::rules::OdooAddonsRelativeImport,
        (Odoo, "W8155") => rules::odoo::rules::BadBuiltinGroupby,
        (Odoo, "W8160") => rules::odoo::rules::DeprecatedOdooModelMethod,
        (Odoo, "W8161") => rules::odoo::rules::PreferEnvTranslation,
        (Odoo, "W8162") => rules::odoo::rules::ManifestExternalAssets,
        (Odoo, "W8163") => rules::odoo::rules::NoSearchAll,
        (Odoo, "W8164") => rules::odoo::rules::SuperMethodMismatch,
        (Odoo, "W8165") => rules::odoo::rules::PreferEnvAttribute,
        (Odoo, "W8202") => rules::odoo::rules::UseVimComment,
        (Odoo, "W8301") => rules::odoo::rules::TranslationNotLazy,
        (Odoo, "W8302") => rules::odoo::rules::TranslationFormatInterpolation,
        (Odoo, "W8303") => rules::odoo::rules::TranslationFstringInterpolation,
        (Odoo, "W8501") => rules::odoo::rules::UnusedLogger,
        ...
        (Odoo, "W9503") => rules::odoo::rules::ModelClassNameMismatch,
        ...
        // also why they keep a plain sequence instead of their pylint-odoo ids (C8117, C8118,
        // C8119): those ids only make sense inside the "OD" numbering they were split out of.
