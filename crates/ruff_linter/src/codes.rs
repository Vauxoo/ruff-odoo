...
pub fn code_to_rule(linter: Linter, code: &str) -> Option<(RuleGroup, Rule)> {
    ...
    Some(match (linter, code) {
        ...
        (Odoo, "003") => rules::odoo::rules::UseVimComment,
        (Odoo, "004") => rules::odoo::rules::ExceptPass,
        (Odoo, "005") => rules::odoo::rules::MethodRequiredSuper,
        (Odoo, "006") => rules::odoo::rules::UnusedLogger,
        (Odoo, "007") => rules::odoo::rules::AttributeStringRedundant,
        (Odoo, "008") => rules::odoo::rules::ManifestRequiredAuthor,
        (Odoo, "009") => rules::odoo::rules::ManifestAuthorString,
        (Odoo, "010") => rules::odoo::rules::LicenseAllowed,
        (Odoo, "011") => rules::odoo::rules::ManifestMaintainersList,
        (Odoo, "012") => rules::odoo::rules::ManifestSummaryMultiline,
        (Odoo, "013") => rules::odoo::rules::DevelopmentStatusAllowed,
        (Odoo, "014") => rules::odoo::rules::WebsiteManifestKeyNotValidUri,
        (Odoo, "015") => rules::odoo::rules::InvalidEmail,
        (Odoo, "016") => rules::odoo::rules::MissingReadme,
        (Odoo, "017") => rules::odoo::rules::InvalidCommit,
        (Odoo, "018") => rules::odoo::rules::ContextOverridden,
        (Odoo, "019") => rules::odoo::rules::BadBuiltinGroupby,
        (Odoo, "020") => rules::odoo::rules::OdooExceptionWarning,
        (Odoo, "021") => rules::odoo::rules::AttributeDeprecated,
        (Odoo, "022") => rules::odoo::rules::MissingReturn,
        (Odoo, "023") => rules::odoo::rules::OdooAddonsRelativeImport,
        (Odoo, "024") => rules::odoo::rules::PreferEnvTranslation,
        (Odoo, "025") => rules::odoo::rules::ManifestSuperfluousKey,
        (Odoo, "026") => rules::odoo::rules::HeaderComments,
        (Odoo, "027") => rules::odoo::rules::MethodCompute,
        (Odoo, "028") => rules::odoo::rules::MethodSearch,
        (Odoo, "029") => rules::odoo::rules::MethodInverse,
        (Odoo, "030") => rules::odoo::rules::RenamedFieldParameter,
        (Odoo, "031") => rules::odoo::rules::TranslationField,
        ...
        (Odoo, "039") => rules::odoo::rules::NoRaiseUnlink,
        (Odoo, "040") => rules::odoo::rules::NoWriteInCompute,
        (Odoo, "041") => rules::odoo::rules::TranslationContainsVariable,
        (Odoo, "042") => rules::odoo::rules::TranslationPositionalUsed,
        (Odoo, "043") => rules::odoo::rules::TranslationInjection,
        ...
        (Odoo, "063") => rules::odoo::rules::ConsiderMergingClassesInherited,
